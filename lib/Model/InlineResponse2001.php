...
class InlineResponse2001 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'block' => '\IdeaEngine\TezosSDK\Model\BlockHash',
        'level' => 'int',
        'errors' => 'mixed'
    ];
     ...
     * Sets block
     *
     * @param \IdeaEngine\TezosSDK\Model\BlockHash $block block
     *
     * @return self
     */
    ...
    public function setLevel($level)
    {
        ...
        if (($level > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $level when calling InlineResponse2001., must be smaller than or equal to 2147483647.');
        }
        if (($level < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $level when calling InlineResponse2001., must be bigger than or equal to -2147483648.');
        }
     ...
     * Sets errors
     *
     * @param mixed $errors The full list of error is available with the global RPC `GET errors`
     *
     * @return self
     */
