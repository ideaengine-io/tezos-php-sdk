...
/**
 * SwapRequestReceived Class Doc Comment
 *
 * @category Class
 * @package  IdeaEngine\TezosSDK
 * @author   OpenAPI Generator team
 ...
 */
class SwapRequestReceived implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Swap_request_received';
    ...
    const EVENT_SWAP_REQUEST_RECEIVED = 'swap_request_received';
    ...
    {
        return [
            self::EVENT_SWAP_REQUEST_RECEIVED,
        ];
    }
