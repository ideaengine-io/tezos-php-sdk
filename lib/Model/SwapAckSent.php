 ...
 */
class SwapAckSent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Swap_ack_sent';
    ...
    const EVENT_SWAP_ACK_SENT = 'swap_ack_sent';
