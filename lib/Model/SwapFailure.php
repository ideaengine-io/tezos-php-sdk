 ...
 */
class SwapFailure implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Swap_failure';
    ...
    const EVENT_SWAP_FAILURE = 'swap_failure';
