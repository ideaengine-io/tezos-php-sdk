 ...
 */
class GcPoints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Gc_points';
    ...
    const EVENT_GC_POINTS = 'gc_points';
