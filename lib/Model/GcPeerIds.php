 ...
 */
class GcPeerIds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Gc_peer_ids';
    ...
    const EVENT_GC_PEER_IDS = 'gc_peer_ids';
