...
/**
 * ExternalDisconnection Class Doc Comment
 *
 * @category Class
 * @package  IdeaEngine\TezosSDK
 * @author   OpenAPI Generator team
 ...
 */
class ExternalDisconnection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'External_disconnection';
    ...
    const EVENT_EXTERNAL_DISCONNECTION = 'external_disconnection';
    ...
    {
        return [
            self::EVENT_EXTERNAL_DISCONNECTION,
        ];
    }
