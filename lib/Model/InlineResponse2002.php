...
class InlineResponse2002 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'bootstrapped' => 'bool',
        'sync_state' => '\IdeaEngine\TezosSDK\Model\ChainStatus'
    ];
    ...
    {
        $this->container['bootstrapped'] = $data['bootstrapped'] ?? null;
        $this->container['sync_state'] = $data['sync_state'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sync_state'] === null) {
            $invalidProperties[] = "'sync_state' can't be null";
        }
     ...
     * Sets bootstrapped
     *
     * @param bool $bootstrapped bootstrapped
     *
     * @return self
     */
     ...
     * Gets sync_state
     *
     * @return \IdeaEngine\TezosSDK\Model\ChainStatus
     */
     ...
     * Sets sync_state
     *
     * @param \IdeaEngine\TezosSDK\Model\ChainStatus $sync_state sync_state
     *
     * @return self
     */
