...
/**
 * OutgoingConnection Class Doc Comment
 *
 * @category Class
 * @package  IdeaEngine\TezosSDK
 * @author   OpenAPI Generator team
 ...
 */
class OutgoingConnection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Outgoing_connection';
    ...
    const EVENT_OUTGOING_CONNECTION = 'outgoing_connection';
    ...
    {
        return [
            self::EVENT_OUTGOING_CONNECTION,
        ];
    }
