...
/**
 * TooManyConnections Class Doc Comment
 *
 * @category Class
 * @package  IdeaEngine\TezosSDK
 * @author   OpenAPI Generator team
 ...
 */
class TooManyConnections implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Too_many_connections';
    ...
    const EVENT_TOO_MANY_CONNECTIONS = 'too_many_connections';
    ...
    {
        return [
            self::EVENT_TOO_MANY_CONNECTIONS,
        ];
    }
