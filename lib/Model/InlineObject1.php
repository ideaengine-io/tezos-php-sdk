...
class InlineObject1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setData($data)
    {
        ...
        if ((!preg_match("/^([a-zA-Z0-9][a-zA-Z0-9])*$/", $data))) {
            throw new \InvalidArgumentException("invalid value for $data when calling InlineObject1., must conform to the pattern /^([a-zA-Z0-9][a-zA-Z0-9])*$/.");
        }
     ...
     * Gets operations
     *
     * @return \IdeaEngine\TezosSDK\Model\Operation[][]
     */
     ...
     * Sets operations
     *
     * @param \IdeaEngine\TezosSDK\Model\Operation[][] $operations operations
     *
     * @return self
     */
