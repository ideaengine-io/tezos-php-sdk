...
/**
 * SwapRequestIgnored Class Doc Comment
 *
 * @category Class
 * @package  IdeaEngine\TezosSDK
 * @author   OpenAPI Generator team
 ...
 */
class SwapRequestIgnored implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Swap_request_ignored';
    ...
    const EVENT_SWAP_REQUEST_IGNORED = 'swap_request_ignored';
    ...
    {
        return [
            self::EVENT_SWAP_REQUEST_IGNORED,
        ];
    }
