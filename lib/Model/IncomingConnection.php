...
/**
 * IncomingConnection Class Doc Comment
 *
 * @category Class
 * @package  IdeaEngine\TezosSDK
 * @author   OpenAPI Generator team
 ...
 */
class IncomingConnection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Incoming_connection';
    ...
    const EVENT_INCOMING_CONNECTION = 'incoming_connection';
    ...
    {
        return [
            self::EVENT_INCOMING_CONNECTION,
        ];
    }
