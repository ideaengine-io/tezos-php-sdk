...
/**
 * TooFewConnections Class Doc Comment
 *
 * @category Class
 * @package  IdeaEngine\TezosSDK
 * @author   OpenAPI Generator team
 ...
 */
class TooFewConnections implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Too_few_connections';
    ...
    const EVENT_TOO_FEW_CONNECTIONS = 'too_few_connections';
    ...
    {
        return [
            self::EVENT_TOO_FEW_CONNECTIONS,
        ];
    }
