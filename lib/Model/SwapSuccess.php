 ...
 */
class SwapSuccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Swap_success';
    ...
    const EVENT_SWAP_SUCCESS = 'swap_success';
