 ...
 */
class Accepted implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Accepted';
    ...
    const EVENT_KIND_ACCEPTED = 'accepted';
