 ...
 */
class Requested implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Requested';
    ...
    const EVENT_KIND_REQUESTED = 'requested';
