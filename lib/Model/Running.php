 ...
 */
class Running implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Running';
    ...
    const EVENT_KIND_RUNNING = 'running';
