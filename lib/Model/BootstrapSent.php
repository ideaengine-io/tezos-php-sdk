...
/**
 * BootstrapSent Class Doc Comment
 *
 * @category Class
 * @package  IdeaEngine\TezosSDK
 * @author   OpenAPI Generator team
 ...
 */
class BootstrapSent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Bootstrap_sent';
    ...
    const EVENT_BOOTSTRAP_SENT = 'bootstrap_sent';
