 ...
 */
class BlockHeader implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Block_header';
    ...
    public function setLevel($level)
    {
        ...
        if (($level > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $level when calling BlockHeader., must be smaller than or equal to 2147483647.');
        }
        if (($level < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $level when calling BlockHeader., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setProto($proto)
    {
        ...
        if (($proto > 255)) {
            throw new \InvalidArgumentException('invalid value for $proto when calling BlockHeader., must be smaller than or equal to 255.');
        }
        if (($proto < 0)) {
            throw new \InvalidArgumentException('invalid value for $proto when calling BlockHeader., must be bigger than or equal to 0.');
        }
    ...
    public function setValidationPass($validation_pass)
    {
        ...
        if (($validation_pass > 255)) {
            throw new \InvalidArgumentException('invalid value for $validation_pass when calling BlockHeader., must be smaller than or equal to 255.');
        }
        if (($validation_pass < 0)) {
            throw new \InvalidArgumentException('invalid value for $validation_pass when calling BlockHeader., must be bigger than or equal to 0.');
        }
    ...
    public function setProtocolData($protocol_data)
    {
        ...
        if ((!preg_match("/^([a-zA-Z0-9][a-zA-Z0-9])*$/", $protocol_data))) {
            throw new \InvalidArgumentException("invalid value for $protocol_data when calling BlockHeader., must conform to the pattern /^([a-zA-Z0-9][a-zA-Z0-9])*$/.");
        }
