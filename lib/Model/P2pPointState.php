...
/**
 * P2pPointState Class Doc Comment
 *
 * @category Class
 ...
 */
class P2pPointState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'p2p_point.state';
    ...
    const EVENT_KIND_DISCONNECTED = 'disconnected';
    ...
    {
        $this->container['event_kind'] = $data['event_kind'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['event_kind'] === null) {
            $invalidProperties[] = "'event_kind' can't be null";
        }
        ...
        if (!is_null($this->container['event_kind']) && !in_array($this->container['event_kind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'event_kind', must be one of '%s'",
                $this->container['event_kind'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['p2p_peer_id'] === null) {
            $invalidProperties[] = "'p2p_peer_id' can't be null";
        }
    ...
    {
        $allowedValues = $this->getEventKindAllowableValues();
        if (!in_array($event_kind, $allowedValues, true)) {
     ...
     * Sets p2p_peer_id
     *
     * @param \IdeaEngine\TezosSDK\Model\CryptoBoxPublicKeyHash $p2p_peer_id p2p_peer_id
     *
     * @return self
     */
